...
> **最新安定版**: [v0.1.0 リリース](https://github.com/Driedsandwich/chat2issue-prompt/releases/tag/v0.1.0) ・ **参考テンプレート**: [`docs/prompts/templates/`](docs/prompts/templates/) ・ **互換状況**: [`docs/prompts/COMPATIBILITY_MATRIX.md`](docs/prompts/COMPATIBILITY_MATRIX.md)
